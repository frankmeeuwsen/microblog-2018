...
$conf['user'] = 'frankmeeuwsen'
$conf['password'] = '3o%Bv63KUhr2(gTgyy@$kHvfPH[Zs6Xjfki@V9c)hdGJBgCHuPB>68k]7z6vr]yK'
$conf['pinapi']='frankmeeuwsen:345EDBF89C7279603302'
# Where to store the database
$conf['db_location'] = File.expand_path("./webexcursions")
# Tag to use for finding bloggable bookmarks
$conf['blog_tag'] = 'leesmap'
# How many posts must be gathered before publishing
$conf['min_count'] = 1
$conf['max_count'] = 10
# relative location of folder for creating drafts
$conf['drafts_folder'] = './_drafts'
...
class Pinboard
  ...
  def unique_bookmarks
      xml = self.get_xml("/v1/posts/recent?tag=#{$conf['blog_tag']}&count={$conf['max_count']}")
